...
// Change this value whenever you want to change the password for everyone.
// After changing it, upload/push this file to GitHub again.
...
document.addEventListener("DOMContentLoaded", () => {
    // Password is now a fixed global password in this code file.
    // To change it for everyone, edit GLOBAL_ADMIN_PASSWORD above and upload/push again.
...
function handleAdminLogin(e) {
    ...
    if (passwordInput.value === GLOBAL_ADMIN_PASSWORD) {
            ...
            <tr>
                <td>
                    <div class="table-product-cell">
                        <img src="${(p.colors && p.colors.length > 0 && p.colors[0].image) ? p.colors[0].image : p.image}" alt="${p.name}" class="table-product-img" onerror="this.onerror=null; this.src='assets/logo.jpg'">
                        <div>
...
function handlePasswordChange(e) {
    ...
    if (successMsg) successMsg.innerText = "Password changes are now global only by editing js/admin.js and uploading to GitHub again.";
}
